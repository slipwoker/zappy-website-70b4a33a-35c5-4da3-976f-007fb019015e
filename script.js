                ...
                .then(function(response) {
                    if (response.ok) {
                        ...
                        if (!contactForm.querySelector('.form-success')) {
                            ...
                            successMsg.textContent = contactForm.getAttribute('data-success-message') || 'Form submitted successfully!';
                            contactForm.appendChild(successMsg);
                        }
                        contactForm.reset();
                        contactForm.querySelectorAll('.valid').forEach(function(f) { f.classList.remove('valid'); });
                    } else {
                        throw new Error('Form submission failed');
                    }
                })
                .catch(function() {
                    const errorMsg = contactForm.querySelector('.form-error') || document.createElement('div');
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '70b4a33a-35c5-4da3-976f-007fb019015e',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '70b4a33a-35c5-4da3-976f-007fb019015e';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '70b4a33a-35c5-4da3-976f-007fb019015e';
